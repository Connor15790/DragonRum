...
const navigation = [
    { name: 'Home', href: '/', },
    { name: 'Rum', href: '/rum_page', },
    { name: 'Whiskey', href: '/whiskey_page', },
    { name: 'Wine', href: '/wine_page', },
]
...
export default function Navbar() {
    ...
    const openDrawer = () => dispatch(setCartOpen(true));
    ...
    return (
        <>
            <Disclosure
                as="nav"
                className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-white/10 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:bg-white/10"
            >
                    ...
                    <div className="relative flex h-16 items-center justify-between">
                        ...
                        <div className="absolute gap-4 inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                            <button
                                type="button"
                                onClick={openDrawer}
                                className="relative rounded-full p-1 text-gray-400 cursor-pointer hover:text-white"
                            >

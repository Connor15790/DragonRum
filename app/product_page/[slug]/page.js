...
async function getProduct(slug) {
    const res = await fetch(
        `http://localhost:3000/api/product/get-one-product?slug=${slug}`,
        { cache: "no-store" }
    );
                        ...
                        <div className="lg:w-4/5 mx-auto flex flex-wrap">
                            ...
                            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                ...
                                <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                                    <div className="flex ml-0 items-center">
                                        ...
                                        <div className="relative">
                                            <select className="rounded border appearance-none text-red-500 border-gray-300 p-1 focus:outline-none focus:ring-2 focus:ring-red-200 focus:border-red-500 text-base pl-3 pr-10">
                                                <option>SM</option>
                                                <option>M</option>
                                                <option>L</option>
                                                <option>XL</option>
                                ...
                                <div className="flex">
                                    ...
                                    <button className="flex ml-auto cursor-pointer text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">
                                        Add to Cart
                                    </button>
